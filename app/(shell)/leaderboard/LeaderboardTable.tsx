    ...
    <>
      ...
      <div className="bg-surface-container-lowest rounded-xl shadow-card overflow-hidden border border-outline-variant/20">
        <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-surface-bright border-b border-surface-variant/50 items-center">
          ...
          <div className="col-span-2 font-label-sm text-label-sm uppercase text-on-surface-variant tracking-wider text-right">SQL Problems Solved</div>
          <div className="col-span-2 font-label-sm text-label-sm uppercase text-on-surface-variant tracking-wider text-right">SQL Accuracy</div>
            ...
            pageItems.map((l) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="col-span-2 font-body-md text-body-md text-on-surface text-right font-medium">{l.sqlProblemsSolved}</div>
                  <div className="col-span-2 font-body-md text-body-md text-on-surface text-right font-semibold">{l.sqlAccuracy}%</div>
                  <div className="col-span-2 font-body-md text-body-md text-on-surface-variant text-right">{l.totalSqlSubmissions}</div>
                </div>
              );
            })
          )}
