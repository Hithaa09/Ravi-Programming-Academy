  ...
  return (
    <div className="max-w-container-max mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard value="—" label="Programming Solved" icon="code" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-card-padding">
          <h2 className="font-headline-md text-headline-md text-on-surface mb-4">SQL Performance</h2>
          <div className="grid grid-cols-2 gap-y-4 text-sm">
            <div>
          ...
          <div className="mt-4 pt-4 border-t border-outline-variant/10">
            ...
            <p className="text-on-surface-variant font-body-sm text-body-sm mt-1">Available after Judge0 integration.</p>
          </div>
        </Card>

        <Card className="p-card-padding lg:col-span-2">
          <h2 className="font-headline-md text-headline-md text-on-surface mb-4">Recent SQL Submissions</h2>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-outline-variant/10 text-sm">
                {stats.recentSubmissions.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="py-6 text-center text-on-surface-variant">No submissions yet.</td>
                  </tr>
