...
export default function DashboardError({
  ...
  return (
    <div className="max-w-container-max mx-auto flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
      <span className="material-symbols-outlined text-[48px] text-on-surface-variant">error</span>
      <h1 className="font-headline-xl text-headline-xl text-on-surface">Dashboard failed to load</h1>
      <p className="font-body-md text-body-md text-on-surface-variant max-w-sm">
        There was a problem fetching dashboard data. This is usually a temporary issue.
      </p>
      <button
        type="button"
        onClick={reset}
